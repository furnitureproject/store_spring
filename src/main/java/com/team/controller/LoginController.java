...
public class LoginController {
    ...
    public Map<String, Object> userloginPost(@RequestBody User user) {
        ...
        try{
            authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(user.getUserId(), user.getUserPw()));
            map.put("status", 200);
    ...
    public Map<String, Object> sellerloginPost(@RequestBody Seller seller) {
        ...
        Map<String, Object> map = new HashMap<String, Object>();
        try{
            authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(seller.getSellerId(), seller.getSellerPw()));
