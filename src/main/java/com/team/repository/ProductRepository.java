...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    List<Product> findByProductTitleIgnoreCaseContainingOrderByProductCodeDesc(String productTitle, Pageable pageable);

    List<Product> findByProductDescIgnoreCaseContainingOrderByProductCodeDesc(String productDesc, Pageable pageable);
    ...
    List<Product> findByProductTitleIgnoreCaseContainingOrderByProductHitDesc(String productTitle, Pageable pageable);
